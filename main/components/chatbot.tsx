...
const Chatbot = () => {
    ...
    return (
        <>
          ...
          <Button
            onClick={toggleChat}
            className="fixed z-50 bottom-6 right-6 h-14 w-14 rounded-full shadow-lg bg-gradient-to-r from-primary to-primary/80 hover:shadow-xl hover:scale-105 transition-all duration-300"
            size="icon"
          >
